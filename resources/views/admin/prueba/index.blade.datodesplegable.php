...
<div id="container ">
    ...
    <div class="row">
        <div class="form-group col-6">
            ...
            <div class="card col-12 py-2 ml-4">



                <div class=" form-area ml-2">
                    <div class="row ">
        ...
        <div class="row">
            ...
            <div class="form-group col-6">
                <div class="card col-12 py-2 ml-2">
                    <div class=" form-area ml-2">
                        <div class="row">
                            <div class="col-6 single-form">
                        ...
                        <a href="{{ url('/datos/store') }}" class="btn btn-primary btn-sm float-right" data-placement="left">
                            {{ __('Guardar') }}
                        </a>
    ...
    <div class="row">
        ...
        <div class="card col-11 ml-4 py-2">
