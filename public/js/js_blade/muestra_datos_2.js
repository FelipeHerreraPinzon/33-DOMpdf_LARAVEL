...
$(document).ready(function () {
    ...
    //Variables requeridas para la construccion del mapa y sus filtros por poligono
    ...
    datos = [];
    //Validacion de acceso a la ubicacion
    if (navigator.geolocation) {
        ...
        //Limpia el mapa del poligono y los marcker
        ...
        //Funcion de crear poligono al dar doble click
        map.on('dblclick', function (event) {
            ...
            for (i = 0; i < data_global.length; i++) {
                ...
                //Filtrado por las ubicaciones del poligono
    ...
    //$("#card_filtros").hide();
    //Muestra o oculta los filtros, cuando se activa se eliminan los marcadores
    $("#btn_filtros").click(function (e) {
        let div = document.getElementById('card_filtros');
        console.log(div);
...
$(document).ready(function () {
    $("#btn_consultas").click(function () {
        ...
        data_filter.forEach(element =>
            result = data_filter.filter(da => "codigo" == 107)
        );
        console.log(result);
        /*
        data_filter = data_filter.filter(da => "codigo" == 107);
        data_filter = data_filter.filter(da => "barrio" == "CAOBOS SALAZAR");
        */
        //barrio: 
