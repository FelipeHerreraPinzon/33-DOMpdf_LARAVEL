...
$(function (event) {
    $("#modalPersona")
        ...
        .on("show.bs.modal", function (e) {
            ...
            if (option == "create") {
                $("#modal-title").text("Creando nuevo cliente");
                $("#persona_id").val("");
                return;
            }
            if (option == "update") {
                $.ajax({
                    ...
                    success: function (response) {
                       ...
                       // $("#contacto").val(response[0].contacto_nombres + " " + response[0].contacto_apellidos);
                        ...
                        $("#modal-title").text("Actualizando datos de :  " + " " + response[0].nombres + " " + response[0].apellidos);
                    },
